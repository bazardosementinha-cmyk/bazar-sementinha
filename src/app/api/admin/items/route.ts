...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from("items")
    .select("id,short_id,title,category,condition,price,price_from,status,created_at,location_box,label_template,is_fragile,is_demo,demo_group,demo_sort,visibility")
