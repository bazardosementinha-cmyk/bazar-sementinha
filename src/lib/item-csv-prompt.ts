...
- subcategory: exemplo "Feminino", "Masculino", "Infantil", "Casa", "Bijuterias", "Decoracao", "Cozinha". Se nao souber, vazio.
- item_type: tipo especifico do item, exemplo "Vestido", "Tenis", "Brinco", "Pelucia", "Travessa", "Quadro", "Kit".
...
- gender: para roupas, "feminino" | "masculino" | "unissex". Se nao se aplicar, vazio.
- age_group: "infantil" | "adolescente" | "adulto". Se nao se aplicar, vazio.
- season: para roupas, "verao" | "inverno" | "meia_estacao" | "todas". Se nao se aplicar, vazio.
...
- notes_internal: observacoes internas para a equipe. Ex.: "medir antes de publicar", "conferir funcionamento", "fragil", "pequena mancha na foto 3".

CSV quoting:
- Se algum campo tiver ponto-e-virgula, aspas ou quebra de linha, coloque entre aspas duplas.
- Se houver aspas dentro do campo, duplique-as.
...
export const BAZAR_ITEM_CSV_PROMPT_COMPACT =
  `Voce e um assistente de catalogacao para um bazar beneficente (Brasil). Analise 3-7 fotos de 1 item e gere UM CSV com cabecalho + 1 linha, separador ";". Responda SOMENTE o CSV. Entrada opcional: Local previsto do item; se informado, preencha location_box. Colunas: ${ITEM_CSV_HEADER_LINE}. Use title curto e description 180-220 caracteres com beneficio pratico + "100% do valor e revertido para a acao social do Bazar do Sementinha". is_fragile/requires_measurement: sim/nao. label_template: P|M|G|TAG|SAQUINHO|FRAGIL.`;
