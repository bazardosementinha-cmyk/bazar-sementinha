...
Regras principais:
- category: prefira "Roupas" | "Calcados" | "Acessorios" | "Casa" | "Brinquedos" | "Artesanato" | "Artesanatos" | "Outros".
...
- age_group (so roupas/calcados infantis): "infantil" | "adolescente" | "adulto". Se nao se aplicar, vazio.
...
- label_template: escolha "P" | "M" | "G" | "TAG" | "SAQUINHO" | "FRAGIL".
  - P: itens pequenos.
  - M: itens comuns.
  - G: caixas, calcados, kits, itens maiores.
